...
if game.PlaceId == 6961824067 then
    sendNotification("Correct game!", "You are in Fling Things and People.", 10, Upvote)
    ...
    sendNotification("Incorrect game!", "Please join Fling Things and People.", 10, Downvote)
end
